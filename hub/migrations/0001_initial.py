# Generated by Django 4.1.2 on 2022-10-31 01:01
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        editable=False,
                        help_text="This value is set on line 1 of the evon.uuid file on your connected server. A unique static IPv4 address is auto-assigned to any new UUID values seen by the Hub.",
                        max_length=36,
                        unique=True,
                        validators=[
                ...
                (
                    ...
                    models.CharField(
                        editable=False,
                        help_text="This value is set using line 2 of the evon.uuid file on your connected server. An index number may be automatically appended if needed for uniqueness to prevent duplicate FQDN's. To change this value, edit your evon.uuid file and restart OpenVPN on your endpoint server.",
                        max_length=255,
                        unique=True,

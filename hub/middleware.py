...
class HubMiddleware:
    ...
    def __call__(self, request):
        ...
        # If we're deployed via AWS Marketplace, show warning messsge to superusers if IAM role is improperly configured.
        if EVON_VARS["hosted_mode"] == "awsmp" and request.user.is_superuser:
            show = True
